...
void DPTriggerAnalyzer::analyzeTrigger(DPMCRawEvent* rawEvent)
{
    ...
    bool H1YL = (rawEvent->getNHits(27) > 0);
    bool H1YR = (rawEvent->getNHits(28) > 0);
    bool H2YL = (rawEvent->getNHits(29) > 0);
    bool H2YR = (rawEvent->getNHits(30) > 0);
    bool H3YL = (rawEvent->getNHits(35) > 0);
    bool H3YR = (rawEvent->getNHits(36) > 0);
    bool H4YL = (rawEvent->getNHits(37) > 0);
    bool H4YR = (rawEvent->getNHits(38) > 0);
    bool H12YL = (rawEvent->getNHits(27) > 0) && (rawEvent->getNHits(29) > 0);
    bool H12YR = (rawEvent->getNHits(28) > 0) && (rawEvent->getNHits(30) > 0);
    bool H13YL = (rawEvent->getNHits(27) > 0) && (rawEvent->getNHits(35) > 0);
    bool H13YR = (rawEvent->getNHits(28) > 0) && (rawEvent->getNHits(36) > 0);
    bool H14YL = (rawEvent->getNHits(27) > 0) && (rawEvent->getNHits(37) > 0);
    bool H14YR = (rawEvent->getNHits(28) > 0) && (rawEvent->getNHits(38) > 0);
    bool H23YL = (rawEvent->getNHits(29) > 0) && (rawEvent->getNHits(35) > 0);
    bool H23YR = (rawEvent->getNHits(30) > 0) && (rawEvent->getNHits(36) > 0);
    bool H24YL = (rawEvent->getNHits(29) > 0) && (rawEvent->getNHits(37) > 0);
    bool H24YR = (rawEvent->getNHits(30) > 0) && (rawEvent->getNHits(38) > 0);
    bool H34YL = (rawEvent->getNHits(35) > 0) && (rawEvent->getNHits(37) > 0);
    bool H34YR = (rawEvent->getNHits(36) > 0) && (rawEvent->getNHits(38) > 0);
    bool H123YL = (rawEvent->getNHits(27) > 0) && (rawEvent->getNHits(29) > 0) && (rawEvent->getNHits(35) > 0);
    bool H123YR = (rawEvent->getNHits(28) > 0) && (rawEvent->getNHits(30) > 0) && (rawEvent->getNHits(36) > 0);
    bool H124YL = (rawEvent->getNHits(27) > 0) && (rawEvent->getNHits(29) > 0) && (rawEvent->getNHits(37) > 0);
    bool H124YR = (rawEvent->getNHits(28) > 0) && (rawEvent->getNHits(30) > 0) && (rawEvent->getNHits(38) > 0);
    bool H234YL = (rawEvent->getNHits(29) > 0) && (rawEvent->getNHits(35) > 0) && (rawEvent->getNHits(37) > 0);
    bool H234YR = (rawEvent->getNHits(30) > 0) && (rawEvent->getNHits(36) > 0) && (rawEvent->getNHits(38) > 0);

    if(HYL || HYR) rawEvent->eventHeader().fTriggerBit |= NIM1;
    if(HXT || HXB) rawEvent->eventHeader().fTriggerBit |= NIM2;
    if(H1YL || H1YR) rawEvent->eventHeader().fTriggerBit |= H1;
    if(H2YL || H2YR) rawEvent->eventHeader().fTriggerBit |= H2;
    if(H3YL || H3YR) rawEvent->eventHeader().fTriggerBit |= H3;
    if(H4YL || H4YR) rawEvent->eventHeader().fTriggerBit |= H4;
    if(H12YL || H12YR) rawEvent->eventHeader().fTriggerBit |= H12;
    if(H13YL || H13YR) rawEvent->eventHeader().fTriggerBit |= H13;
    if(H14YL || H14YR) rawEvent->eventHeader().fTriggerBit |= H14;
    if(H23YL || H23YR) rawEvent->eventHeader().fTriggerBit |= H23;
    if(H24YL || H24YR) rawEvent->eventHeader().fTriggerBit |= H24;
    if(H34YL || H34YR) rawEvent->eventHeader().fTriggerBit |= H34;
    if(H123YL || H123YR) rawEvent->eventHeader().fTriggerBit |= H123;
    if(H124YL || H124YR) rawEvent->eventHeader().fTriggerBit |= H124;
    if(H234YL || H234YR) rawEvent->eventHeader().fTriggerBit |= H234;
